...
// Strings for SA
$string['sa_enabled'] = 'Functions for Semesterapparat active';
$string['sa_email_library'] = 'e-mail address of the library';
$string['sa'] = 'Semesterapparat';
$string['sa_location'] = 'Place of Semesterapparat';
$string['sa_semester'] = 'Semester of Semesterapparat';
$string['sa_course'] = 'Course of Semesterapparat';
...
$string['sa_sent0'] = 'Attention!';
$string['sa_sent1'] = 'This Semesterapparat already was sent to the library on ';
$string['sa_sent2'] = '.';
...
$string['sa_emaillib_listname'] = 'Name of the list:';
$string['sa_emaillib_list'] = 'List of the titles:';
